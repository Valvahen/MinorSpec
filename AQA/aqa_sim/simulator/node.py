...
# Trust score weights (uptime, voting agreement, response time, honesty).
# Exposed as module-level constants to support sensitivity analysis.
W_UPTIME: float = 0.35
W_VOTING: float = 0.30
W_RTT: float = 0.20
W_HONESTY: float = 0.15
